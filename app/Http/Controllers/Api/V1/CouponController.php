...
class CouponController extends Controller
{
    ...
    public function validate(Request $request): JsonResponse {
        ...
        try { $r = $this->service->validate($data['code'], $data['subtotal'], $data['customer_phone']); return $this->success(['coupon' => $r['coupon'], 'discount_amount' => $r['discount_amount']]); }
        catch (\InvalidArgumentException $e) { return $this->error($e->getMessage(), 422); }
    }
    public function index(): JsonResponse { return $this->success($this->repo->all()); }
